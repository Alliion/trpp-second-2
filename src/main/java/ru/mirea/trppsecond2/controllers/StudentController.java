package ru.mirea.trppsecond2.controllers;

import com.opencsv.bean.CsvToBeanBuilder;
import io.micronaut.http.HttpResponse;
import io.micronaut.http.annotation.Controller;
import io.micronaut.http.annotation.Get;
import ru.mirea.trppsecond2.entity.Student;
...
public class StudentController {
    ...
    public StudentController() {
        studentList = new CsvToBeanBuilder<Student>(new InputStreamReader(this.getClass().
                getResourceAsStream("/MOCK_DATA.csv"))).withType(Student.class).build().parse();
    }
